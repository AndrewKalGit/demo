...
import panflipmain from './—Pngtree—farmland vegetables_5925486 2.png';
import panfip1 from './image 3.png'
import panfip2 from './image 4.png'
import ramsey from './Ellipse 1.png'
...
<section className="vh-x">
  ...
  >
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-0">
      <div
        class="relative h-96 w-96 overflow-hidden rounded-lg lg:order-last lg:w-full lg:h-full"
      >
        <img
          alt="Party"
          src={panflipmain}
    ...
    <div class="mt-12 grid grid-cols-1 gap-4 md:grid-cols-3 md:gap-8">
      <blockquote class="rounded-lg bg-green p-8">
        <div class="flex items-center gap-4">
          ...
          <div>
            <div class="flex justify-center gap-0.5 text-gray-800">
              <svg
            ...
            <p class="mt-1 text-lg font-medium text-gray-50">Gordan Ramsey</p>
          </div>
        </div>

        <p class="line-clamp-2 sm:line-clamp-none mt-4 text-gray-50">
      ...
      <blockquote class="rounded-lg bg-green p-8">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="mt-1 text-lg font-medium text-gray-50">Jordan Ramsey</p>
          </div>
        </div>
      ...
      <blockquote class="rounded-lg bg-green p-8">
        <div class="flex items-center gap-4">
          ...
          <div>
            ...
            <p class="mt-1 text-lg font-medium text-gray-50">Paul Ramsey</p>
          </div>
        </div>
